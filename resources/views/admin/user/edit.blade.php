		                        ...
		                        <form enctype="multipart/form-data" action="{{ route('user.update',$user->id) }}" method="POST">
		                        	...
		                        	<div class="row">
			                        	<div class="form-group col-md-4">
			                            	<label>Name</label>
			                                <input type="text" name="name" class="form-control input-default" placeholder="Enter Your Name" value="{{ $user->name }}">
			                                @if($errors->has('name'))
			                            ...
			                            <div class="form-group col-md-4">
			                            	<label>Email</label>
			                                <input type="text" name="email" class="form-control input-default" placeholder="Enter Email id" value="{{ $user->email }}">
			                                @if($errors->has('email'))
							                    <p class="d-block invalid-feedback animated fadeInDown" style="">
							                        {{ $errors->first('email') }}
							                    </p>
			                            ...
			                            <div class="form-group col-md-4">
			                            	<label>Mobile</label>
			                                <input type="text" name="mobile_no" class="form-control input-default" placeholder="Enter Mobile Number" value="{{ $user->mobile }}">
		                            ...
		                            <div class="col-xs-12 col-sm-12 col-md-12 ">
						            	<button type="submit" class="btn btn-primary">Edit User Information</button>
						            </div>
		                        </form>
		                    </div>
		                </div>
