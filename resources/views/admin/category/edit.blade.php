		                        ...
		                        <form enctype="multipart/form-data" action="{{ route('category.update',$category->id) }}" method="POST">
		                        	...
		                        	<div class="row">
			                        	<div class="form-group col-md-4">
			                            	<label>Name*</label>
			                                <input type="text" name="category_name" value="{{ $category->category_name }}" class="form-control input-default" placeholder="Enter Category Name">
			                            ...
			                            <div class="form-group col-md-4">
			                            	<label>Type</label>
			                                <input type="text" name="type" value="{{ $category->type }}" class="form-control input-default" placeholder="Enter Category Type">
			                                @if($errors->has('type'))
							                    <p class="d-block invalid-feedback animated fadeInDown" style="">
							                        {{ $errors->first('type') }}
							                    </p>
