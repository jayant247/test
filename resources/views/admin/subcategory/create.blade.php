		                        ...
		                        <form enctype="multipart/form-data" action="{{ route('subcategory.store') }}" method="POST">
		                        	...
		                        	<div class="row">
			                        	<div class="form-group col-md-4">
			                            	<label>Name*</label>
			                                <input type="text" name="category_name" class="form-control input-default" placeholder="Enter Sub-Category Name">
			                            ...
			                            <div class="form-group col-md-4">
			                            	<label>Type</label>
			                                <input type="text" name="type" class="form-control input-default" placeholder="Enter Sub-Category Type">
			                                @if($errors->has('type'))
							                    <p class="d-block invalid-feedback animated fadeInDown" style="">
							                        {{ $errors->first('type') }}
							                    </p>
